import 'package:college_dashboard/pages/user/home/subcategories/aboutus.dart';
...
class _changePassState extends State<changePass> {
  ...
  updatePass() async {
    if(newPassword.length<6){
      Utils().toastmessage("Password should consist of at least 6 characters");
      setState(() {
        status=0;
      });
      return ;
    ...
    Utils().toastmessage("Your Password has been Changed, LogIn Again!!");
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => Login()));
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                          ...
                          child: status==0?const Text(
                            'Change Password',
                            style: TextStyle(
                                fontSize: 18.0, color: Colors.black87),
                          )
                              :
                              LoadingAnimationWidget.beat(color: kblack, size: 20)
                      ),
                    )
                  ],
                ),
