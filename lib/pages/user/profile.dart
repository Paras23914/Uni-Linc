...
class _profileState extends State<profile> {
  ...
  String? studentName; // Initialize with null for proper handling
  String? branchName;
  String? rollNo;
  DocumentSnapshot? _userDataSnapshot; // Store fetched user data
  ...
  void initState() {
    super.initState();
    _fetchUserData(); // Call the function to fetch data during initialization
  }
  ...
  Future<void> _fetchUserData() async {
    try {
      ...
      if (snapshot.exists) {
        setState(() {
          _userDataSnapshot = snapshot; // Store the snapshot
