...
import 'package:college_dashboard/pages/user/home/subcategories/Videos/EditVideos.dart';
...
class _AllVideosState extends State<AllVideos> {
  ...
  Widget ViewVideo(String title, String description, int date, String filename, String link, String id, DocumentReference data) {
    return Container(
    ...
    return Scaffold(
      ...
      body: email == null
        ...
        child: Text(
          ...
          : StreamBuilder(
        stream: firestore.collection('Videos')
          ...
          if (snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ViewVideo(
                    ...
                    firestore.collection('Videos').doc(snapshot.data!.docs[index].id),
                  );
                },
              );
            }
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              if (snapshot.hasError) {
                ...
                return const Center(
                  child: Text(
                    "No Video Lecture Shared by You",
                    style: TextStyle(color: Colors.white70),
                  ),
                );
              }
