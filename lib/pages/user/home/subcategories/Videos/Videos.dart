...
import 'package:college_dashboard/pages/user/home/subcategories/Videos/AddVideos.dart';
import 'package:college_dashboard/pages/user/home/subcategories/Videos/AllVideos.dart';
import 'package:college_dashboard/pages/user/home/subcategories/Videos/ViewVideo.dart';
...
class _VideosState extends State<Videos> {
  ...
  Widget ViewVideos(String title, String des, int date, String id) {
    return Container(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ViewVideoDetail(
                    id: id,
                  )
              )
          );
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Center(
              child: Text(
                "Video Lectures for ${branch ?? ""} ${dept ?? ""}",
